-- ============================================================
-- PeTa — admin approval history.
--
-- Mirrors admin_pending_approvals but returns approved + rejected
-- assignments so admins can audit past decisions, re-check the
-- screenshot/URL/comment, and see the rejection reason that was
-- sent to the army member.
-- ============================================================
...
GRANT EXECUTE ON FUNCTION public.admin_approval_history(text) TO authenticated;
