...
export const LEVELS = [
  ...
  { level: 1, emoji: '🦴', name: 'Cave Baby',        minKarma: 0,     minDays: 0,   maxKarma: 99,       maxDays: 29,       reward: 8000  },
  { level: 2, emoji: '🔥', name: 'Cave Teen',        minKarma: 0,     minDays: 0,   maxKarma: 499,      maxDays: 89,       reward: 11000 },
  { level: 3, emoji: '⚔️', name: 'Village Warrior',  minKarma: 0,     minDays: 0,   maxKarma: 1999,     maxDays: 179,      reward: 14000 },
  { level: 4, emoji: '🏙️', name: 'City Slicker',    minKarma: 0,     minDays: 0,   maxKarma: 9999,     maxDays: 364,      reward: 17000 },
