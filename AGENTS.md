# PeTa — Project State for Codex

> Auto-loaded into every Codex session. Keep this file dense and current.
...
- **Project root:** `D:\Codex Cowork\Reddit Army Local\` — the actual app lives in `peta/` subfolder
