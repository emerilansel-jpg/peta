...
CREATE OR REPLACE FUNCTION public.admin_list_tash_notifications(p_task_id uuid)
RETURNS TABLE (
  id uuid,
  channel text,
  phone text,
...
REVOKE ALL ON FUNCTION public.admin_list_tash_notifications(uuid) FROM PUBLIC;
